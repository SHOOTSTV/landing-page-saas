      ...
      <Container className="relative z-10 pt-10 lg:py-16 space-y-16">
        <div className="text-center max-w-2xl mx-auto px-16 lg:px-0 space-y-7">
          ...
          <p className="body-1 text-n-5">
            ...
            Architecto, iste eligendi quis doloremque illum, nemo officiis
            fugit, eos obcaecati soluta quasi placeat. Consequatur alias commodi
            delectus laborum neque deserunt aspernatur.
          </p>
